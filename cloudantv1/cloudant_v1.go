...
// PostLocalDocs : Query a list of all local documents in a database
...
func (cloudant *CloudantV1) PostLocalDocs(postLocalDocsOptions *PostLocalDocsOptions) (result *AllDocsResult, response *core.DetailedResponse, err error) {
	...
	err = core.ValidateStruct(postLocalDocsOptions, "postLocalDocsOptions")
	if err != nil {
		return
	}
	...
	for headerName, headerValue := range postLocalDocsOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("cloudant", "V1", "PostLocalDocs")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	builder.AddHeader("Content-Type", "application/json")
	if postLocalDocsOptions.Accept != nil {
		builder.AddHeader("Accept", fmt.Sprint(*postLocalDocsOptions.Accept))
	}

	body := make(map[string]interface{})
	if postLocalDocsOptions.AttEncodingInfo != nil {
		body["att_encoding_info"] = postLocalDocsOptions.AttEncodingInfo
	}
	if postLocalDocsOptions.Attachments != nil {
		body["attachments"] = postLocalDocsOptions.Attachments
	}
	if postLocalDocsOptions.Conflicts != nil {
		body["conflicts"] = postLocalDocsOptions.Conflicts
	}
	if postLocalDocsOptions.Descending != nil {
		body["descending"] = postLocalDocsOptions.Descending
	}
	if postLocalDocsOptions.IncludeDocs != nil {
		body["include_docs"] = postLocalDocsOptions.IncludeDocs
	}
	if postLocalDocsOptions.InclusiveEnd != nil {
		body["inclusive_end"] = postLocalDocsOptions.InclusiveEnd
	}
	if postLocalDocsOptions.Limit != nil {
		body["limit"] = postLocalDocsOptions.Limit
	}
	if postLocalDocsOptions.Skip != nil {
		body["skip"] = postLocalDocsOptions.Skip
	}
	if postLocalDocsOptions.UpdateSeq != nil {
		body["update_seq"] = postLocalDocsOptions.UpdateSeq
	}
	if postLocalDocsOptions.Endkey != nil {
		body["endkey"] = postLocalDocsOptions.Endkey
	}
	if postLocalDocsOptions.Key != nil {
		body["key"] = postLocalDocsOptions.Key
	}
	if postLocalDocsOptions.Keys != nil {
		body["keys"] = postLocalDocsOptions.Keys
	}
	if postLocalDocsOptions.Startkey != nil {
		body["startkey"] = postLocalDocsOptions.Startkey
	}
	_, err = builder.SetBodyContentJSON(body)
	if err != nil {
		return
...
// PostLocalDocsQueries : Multi-query the list of all local documents in a database
...
func (cloudant *CloudantV1) PostLocalDocsQueries(postLocalDocsQueriesOptions *PostLocalDocsQueriesOptions) (result *AllDocsQueriesResult, response *core.DetailedResponse, err error) {
	...
	err = core.ValidateStruct(postLocalDocsQueriesOptions, "postLocalDocsQueriesOptions")
	if err != nil {
		return
	}
	...
	for headerName, headerValue := range postLocalDocsQueriesOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("cloudant", "V1", "PostLocalDocsQueries")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	builder.AddHeader("Content-Type", "application/json")
	if postLocalDocsQueriesOptions.Accept != nil {
		builder.AddHeader("Accept", fmt.Sprint(*postLocalDocsQueriesOptions.Accept))
	}

	body := make(map[string]interface{})
	if postLocalDocsQueriesOptions.Queries != nil {
		body["queries"] = postLocalDocsQueriesOptions.Queries
	}
	_, err = builder.SetBodyContentJSON(body)
	if err != nil {
		return
...
// NewPostLocalDocsOptions : Instantiate PostLocalDocsOptions
func (*CloudantV1) NewPostLocalDocsOptions(db string) *PostLocalDocsOptions {
	return &PostLocalDocsOptions{
		Db: core.StringPtr(db),
	}
}

// SetDb : Allow user to set Db
func (options *PostLocalDocsOptions) SetDb(db string) *PostLocalDocsOptions {
	options.Db = core.StringPtr(db)
	return options
}

// SetAccept : Allow user to set Accept
func (options *PostLocalDocsOptions) SetAccept(accept string) *PostLocalDocsOptions {
	options.Accept = core.StringPtr(accept)
	return options
}

// SetAttEncodingInfo : Allow user to set AttEncodingInfo
func (options *PostLocalDocsOptions) SetAttEncodingInfo(attEncodingInfo bool) *PostLocalDocsOptions {
	options.AttEncodingInfo = core.BoolPtr(attEncodingInfo)
	return options
}

// SetAttachments : Allow user to set Attachments
func (options *PostLocalDocsOptions) SetAttachments(attachments bool) *PostLocalDocsOptions {
	options.Attachments = core.BoolPtr(attachments)
	return options
}

// SetConflicts : Allow user to set Conflicts
func (options *PostLocalDocsOptions) SetConflicts(conflicts bool) *PostLocalDocsOptions {
	options.Conflicts = core.BoolPtr(conflicts)
	return options
}

// SetDescending : Allow user to set Descending
func (options *PostLocalDocsOptions) SetDescending(descending bool) *PostLocalDocsOptions {
	options.Descending = core.BoolPtr(descending)
	return options
}

// SetIncludeDocs : Allow user to set IncludeDocs
func (options *PostLocalDocsOptions) SetIncludeDocs(includeDocs bool) *PostLocalDocsOptions {
	options.IncludeDocs = core.BoolPtr(includeDocs)
	return options
}

// SetInclusiveEnd : Allow user to set InclusiveEnd
func (options *PostLocalDocsOptions) SetInclusiveEnd(inclusiveEnd bool) *PostLocalDocsOptions {
	options.InclusiveEnd = core.BoolPtr(inclusiveEnd)
	return options
}

// SetLimit : Allow user to set Limit
func (options *PostLocalDocsOptions) SetLimit(limit int64) *PostLocalDocsOptions {
	options.Limit = core.Int64Ptr(limit)
	return options
}

// SetSkip : Allow user to set Skip
func (options *PostLocalDocsOptions) SetSkip(skip int64) *PostLocalDocsOptions {
	options.Skip = core.Int64Ptr(skip)
	return options
}

// SetUpdateSeq : Allow user to set UpdateSeq
func (options *PostLocalDocsOptions) SetUpdateSeq(updateSeq bool) *PostLocalDocsOptions {
	options.UpdateSeq = core.BoolPtr(updateSeq)
	return options
}

// SetEndkey : Allow user to set Endkey
func (options *PostLocalDocsOptions) SetEndkey(endkey string) *PostLocalDocsOptions {
	options.Endkey = core.StringPtr(endkey)
	return options
}

// SetKey : Allow user to set Key
func (options *PostLocalDocsOptions) SetKey(key string) *PostLocalDocsOptions {
	options.Key = core.StringPtr(key)
	return options
}

// SetKeys : Allow user to set Keys
func (options *PostLocalDocsOptions) SetKeys(keys []string) *PostLocalDocsOptions {
	options.Keys = keys
	return options
}

// SetStartkey : Allow user to set Startkey
func (options *PostLocalDocsOptions) SetStartkey(startkey string) *PostLocalDocsOptions {
	options.Startkey = core.StringPtr(startkey)
	return options
}

// SetHeaders : Allow user to set Headers
func (options *PostLocalDocsOptions) SetHeaders(param map[string]string) *PostLocalDocsOptions {
	options.Headers = param
	return options
}
...
// SetDb : Allow user to set Db
func (options *PostLocalDocsQueriesOptions) SetDb(db string) *PostLocalDocsQueriesOptions {
	options.Db = core.StringPtr(db)
	return options
}
...
// SetHeaders : Allow user to set Headers
func (options *PostLocalDocsQueriesOptions) SetHeaders(param map[string]string) *PostLocalDocsQueriesOptions {
	options.Headers = param
	return options
}
